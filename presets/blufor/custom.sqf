...
*/
FOB_typename = "CampEast_EP1";                                    // This is the main FOB HQ building.
FOB_box_typename = "B_Slingload_01_Cargo_F";                            // This is the FOB as a container.
FOB_truck_typename = "CFP_B_AFARMY_MTVR_01";                                // This is the FOB as a vehicle.
Arsenal_typename = "CFP_B_AFARMY_SupplyBox";                                   // This is the virtual arsenal as portable supply crates.
Respawn_truck_typename = "CFP_B_AFARMY_M113_Ambulance_01";                        // This is the mobile respawn (and medical) truck.
huron_typename = "CFP_B_AFARMY_M113_Ambulance_01";                       // This is Spartan 01, a multipurpose mobile respawn as a helicopter.
crewman_classname = "CUP_O_TK_INS_Mechanic";                                         // This defines the crew for vehicles.
pilot_classname = "CUP_O_TK_INS_Mechanic";                                      // This defines the pilot for helicopters.
...
KP_liberation_truck_classname = "CFP_B_AFARMY_MTVR_01";               // These are the trucks which are used in the logistic convoy system.
...
*/
infantry_units = [
    ["CUP_O_TK_INS_Soldier",15,0,0],                                        // Rifleman
    ["CUP_O_TK_INS_Bomber",20,0,0],                               // Rifleman (backpack)
    ["CUP_O_TK_INS_Soldier_AT",30,0,0],                                     // Rifleman (RPG-7)
    ["CUP_O_TK_INS_Soldier_GL",25,0,0],                                     // Grenadier
    ["CUP_O_TK_INS_Soldier_AR",25,0,0],                                     // Automatic Rifleman
    ["CUP_O_TK_INS_Soldier_MG",35,0,0],                                     // Machinegunner
    ["CUP_O_TK_INS_Sniper",30,0,0],                                      // Marksman
    ["CUP_O_TK_INS_Soldier_AT",50,10,0],                                   // AT Specialist
    ["CUP_O_TK_INS_Soldier_AT",50,10,0],                                    // AA Specialist
    ["CUP_O_TK_INS_Guerilla_Medic",30,0,0],                                          // Medic
    ["CUP_O_TK_INS_Bomber",30,0,0],                                       // Engineer
    ["CUP_O_TK_INS_Soldier_TL",30,0,0],                                     // Special Team Leader
    ["CUP_O_TK_INS_Soldier_FNFAL",30,0,0],                                        // Special Soldier
    ["cfp_o_is_machinegunner",40,0,0],                                     // Special Machinegunner
    ["CFP_O_TBAN_Sniper_01",70,5,0],                                         // Sniper
    ["CFP_O_TBAN_Sniper_2_01",70,5,0],                                    // Sniper (KSVK)
    ["cfp_o_is_sniper",70,5,0],                               // Sniper (night)
    ["cfp_o_is_irregular",20,0,0],                                        // Spotter
    ["CUP_O_TK_INS_Mechanic",10,0,0],                                           // Crewman
    ["CUP_O_TK_INS_Mechanic",10,0,0]                                           // Pilot
];
